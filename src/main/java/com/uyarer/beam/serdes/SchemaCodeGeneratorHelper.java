...
import com.uyarer.beam.serdes.exceptions.SchemaAssistantException;
...
public class SchemaCodeGeneratorHelper {
   ...
   * @return
   */
  public JClass classFromFieldType(org.apache.beam.sdk.schemas.Schema.FieldType fieldType) {
    JClass outputClass;
      ...
      case LOGICAL_TYPE:
        switch (fieldType.getLogicalType().getIdentifier()) {
          case FixedBytes.IDENTIFIER:
            return classFromFieldType(org.apache.beam.sdk.schemas.Schema.FieldType.BYTES);
          case EnumerationType.IDENTIFIER:
          case CharType.IDENTIFIER:
            return classFromFieldType(org.apache.beam.sdk.schemas.Schema.FieldType.STRING);
          default:
            throw new SchemaAssistantException(
   ...
   * @return
   */
  public static boolean isComplexType(org.apache.beam.sdk.schemas.Schema.FieldType fieldType) {
